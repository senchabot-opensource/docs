---
title: Kick Botu — Şarkı İstekleri
description: Kick sohbetinden gelen şarkı isteklerini manuel veya Spotify otomatik oynatma modlarıyla yönetin.
---
...
| :-- | :-- |
| `!songreq` / `!songrequest` | Herkes (abone-only ayarlarına uygun) |
