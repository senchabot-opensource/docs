---
title: Kick Botu — Tetikleyiciler
description: "Senchabot Kick botu için tetikleyiciler: sohbet mesajları ve yayın olayları, eşleşme tipleri, izinler ve denetim hedef kitleleri, yanıt eylemleri, değişkenler ve bekleme süreleri."
---

# Kick Botu — Tetikleyiciler <Badge type="warning" text="GÜNCELLENDİ"/>

Tetikleyiciler, panodan yapılandırdığınız otomatik kurallardır (**Panel → Kick → `<kanal>` → Tetikleyiciler**). Bir **sohbet mesajı** kuralınızla eşleştiğinde veya **yayın olayları** gerçekleştiğinde (yayın başlangıcı, belirli bir yayın süresine ulaşılması, kategori değişikliği veya yayın bitişi) çalışabilirler.
...
| **OG** | Kick OG rozetine sahip kullanıcılar, modlar ve yayıncı |
| **Moderatör** | Modlar ve yayıncı |
| **Yayıncı** | Yalnızca kanal sahibi |

### Yayın meta verisi tetikleyicileri

Yayın ayarlarını değiştiren eylemler (**Yayın Kategorisini Güncelle**, **Yayın Etiketlerini Güncelle**, **Yayın Başlığını, Etiketlerini ve Kategorisini Güncelle**) güvenilir kanal rolleriyle sınırlandırılmıştır: **VIP**, **OG**, **Moderatör** veya **Yayıncı**. Normal izleyiciler ve standart aboneler bu tetikleyicileri çalıştıramaz.
...
- VIP ve OG rozetleri bu moderasyon kontrolünü atlayamaz; yalnızca kanal **moderatörleri** ve **yayıncı** muaftır.
...
| **Kullanıcıya zaman aşımı** | Tetikleyen kullanıcıya yapılandırılabilir süreyle Kick sohbet zaman aşımı uygular |
| **Kullanıcıyı banla** | Kullanıcıyı kanaldan kalıcı olarak yasaklar |
| **Yayın Kategorisini Güncelle** | Kanalın yayın kategorisini değiştirir |
...
- Moderasyon eylemleri, botun Kick kanalınızda moderatör yetkisine sahip olmasını gerektirir.

### Yayın meta verisi eylemleri

Yayın meta verisi tetikleyicileri, yayın ayrıntılarınızı sohbet komutlarından veya yayın olaylarından otomatik olarak güncellemenize olanak tanır:

- **Yayın Kategorisi**: Yeni kategori adını belirleyin (ör. `Just Chatting`).
- **Yayın Etiketleri**: Virgülle ayrılmış etiketleri girin (ör. `Türkçe, Sohbet, Oyun`).
...
| **Yayın Etiketlerini Güncelle** | **Komut**: `etiketler` | Kimler tetikleyebilir: **Moderatör** | Yayın Etiketleri: `Türkçe, Sohbet, Dereceli` (`!etiketler` komutuyla etiketleri günceller) |
| **Yayın Başlığını, Etiketlerini ve Kategorisini Güncelle** | **Komut**: `oyun` | Kimler tetikleyebilir: **Moderatör** | Yayın Kategorisi: `Minecraft`, Yayın Etiketleri: `Oyun, Hayatta Kalma`, Yayın Varsayılan Başlığı: `Minecraft oynuyoruz!` (`!oyun 100. Gün Hardcore` yazıldığında başlığı "100. Gün Hardcore", kategoriyi Minecraft ve etiketleri otomatik günceller) |
...
Kullanıma hazır otomatik moderasyon ön ayarları (**BÜYÜK HARF Tespiti**, abone muafiyetli **Link Engelleyici** ve **Tekrarlayan İhlallerde Zaman Aşımı**) için özel [Moderasyon](/tr/kick-bot/moderation) kılavuzuna göz atın.
