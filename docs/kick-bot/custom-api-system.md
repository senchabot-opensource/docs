...
Use the link in the format `https://nowplaying.aidenwallis.co.uk/...` under the title "Now Playing Widget" on Aiden Wallis' website as a browser source in your streaming software (OBS Studio, Streamlabs...).
