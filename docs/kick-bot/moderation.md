...
Your chat moderates itself while you stream. Turn it on at **Dashboard → Kick → `<channel>` → Moderation** (`/dashboard/kick/<channel-id>/moderation`): pick a preset, choose what happens on a violation, done.
